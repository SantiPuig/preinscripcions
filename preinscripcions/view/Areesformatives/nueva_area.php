		...
		<section id="content">
			...
			<?php 
			   foreach($arees as $a) {
			   	  ...
			   	  echo "<td><a href='index.php?controlador=areaformativa&operacion=ver&parametro=$a->id'>";
			   	  echo "<img class='boton' src='images/botones/ver.png'> </a>";
			   	  echo "<a href='index.php?controlador=areaformativa&operacion=modificar&parametro=$a->id'>";
